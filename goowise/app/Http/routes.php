...
Route::post('admin/headline/listing', 'Admin\Headline@listing');
Route::post('admin/headline/create', 'Admin\Headline@create');
Route::post('admin/headline/add', 'Admin\Headline@add');
Route::post('admin/headline/edit', 'Admin\Headline@edit');
Route::post('admin/headline/update', 'Admin\Headline@update');
Route::post('admin/headline/destroy', 'Admin\Headline@destroy');
